...
func CreateInstance(pCreateInfo *InstanceCreateInfo, pAllocator *AllocationCallbacks, pInstance *Instance_T) Result {
	...
	cpInstance, cpInstanceAllocMap := (*C.struct_VkInstance_T)(unsafe.Pointer(pInstance)), cgoAllocsUnknown
...
func DestroyInstance(instance Instance_T, pAllocator *AllocationCallbacks) {
	cinstance, cinstanceAllocMap := *(*C.struct_VkInstance_T)(unsafe.Pointer(&instance)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func EnumeratePhysicalDevices(instance Instance_T, pPhysicalDeviceCount *uint32, pPhysicalDevices []PhysicalDevice_T) Result {
	cinstance, cinstanceAllocMap := *(*C.struct_VkInstance_T)(unsafe.Pointer(&instance)), cgoAllocsUnknown
	cpPhysicalDeviceCount, cpPhysicalDeviceCountAllocMap := (*C.uint32_t)(unsafe.Pointer(pPhysicalDeviceCount)), cgoAllocsUnknown
	cpPhysicalDevices, cpPhysicalDevicesAllocMap := (*C.struct_VkPhysicalDevice_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pPhysicalDevices)).Data)), cgoAllocsUnknown
...
func GetPhysicalDeviceFeatures(physicalDevice PhysicalDevice_T, pFeatures *PhysicalDeviceFeatures) {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
...
func GetPhysicalDeviceFormatProperties(physicalDevice PhysicalDevice_T, format Format, pFormatProperties *FormatProperties) {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
...
func GetPhysicalDeviceImageFormatProperties(physicalDevice PhysicalDevice_T, format Format, kind ImageType, tiling ImageTiling, usage ImageUsageFlags, flags ImageCreateFlags, pImageFormatProperties *ImageFormatProperties) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cformat, cformatAllocMap := (C.VkFormat)(format), cgoAllocsUnknown
...
func GetPhysicalDeviceProperties(physicalDevice PhysicalDevice_T, pProperties *PhysicalDeviceProperties) {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
...
func GetPhysicalDeviceQueueFamilyProperties(physicalDevice PhysicalDevice_T, pQueueFamilyPropertyCount *uint32, pQueueFamilyProperties []QueueFamilyProperties) {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
...
func GetPhysicalDeviceMemoryProperties(physicalDevice PhysicalDevice_T, pMemoryProperties *PhysicalDeviceMemoryProperties) {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
...
func CreateDevice(physicalDevice PhysicalDevice_T, pCreateInfo *DeviceCreateInfo, pAllocator *AllocationCallbacks, pDevice *Device_T) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpDevice, cpDeviceAllocMap := (*C.struct_VkDevice_T)(unsafe.Pointer(pDevice)), cgoAllocsUnknown
...
func DestroyDevice(device Device_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func EnumerateDeviceExtensionProperties(physicalDevice PhysicalDevice_T, pLayerName string, pPropertyCount *uint32, pProperties []ExtensionProperties) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cpLayerName, cpLayerNameAllocMap := unpackPCharString(pLayerName)
	cpPropertyCount, cpPropertyCountAllocMap := (*C.uint32_t)(unsafe.Pointer(pPropertyCount)), cgoAllocsUnknown
	cpProperties, cpPropertiesAllocMap := unpackArgSExtensionProperties(pProperties)
...
func EnumerateDeviceLayerProperties(physicalDevice PhysicalDevice_T, pPropertyCount *uint32, pProperties []LayerProperties) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cpPropertyCount, cpPropertyCountAllocMap := (*C.uint32_t)(unsafe.Pointer(pPropertyCount)), cgoAllocsUnknown
	cpProperties, cpPropertiesAllocMap := unpackArgSLayerProperties(pProperties)
...
func GetDeviceQueue(device Device_T, queueFamilyIndex uint32, queueIndex uint32, pQueue *Queue_T) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	...
	cpQueue, cpQueueAllocMap := (*C.struct_VkQueue_T)(unsafe.Pointer(pQueue)), cgoAllocsUnknown
...
func QueueSubmit(queue Queue_T, submitCount uint32, pSubmits []SubmitInfo, fence Fence_T) Result {
	cqueue, cqueueAllocMap := *(*C.struct_VkQueue_T)(unsafe.Pointer(&queue)), cgoAllocsUnknown
	...
	cfence, cfenceAllocMap := *(*C.struct_VkFence_T)(unsafe.Pointer(&fence)), cgoAllocsUnknown
...
func QueueWaitIdle(queue Queue_T) Result {
	cqueue, cqueueAllocMap := *(*C.struct_VkQueue_T)(unsafe.Pointer(&queue)), cgoAllocsUnknown
...
func DeviceWaitIdle(device Device_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
...
func AllocateMemory(device Device_T, pAllocateInfo *MemoryAllocateInfo, pAllocator *AllocationCallbacks, pMemory *DeviceMemory_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpAllocateInfo, cpAllocateInfoAllocMap := pAllocateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpMemory, cpMemoryAllocMap := (*C.struct_VkDeviceMemory_T)(unsafe.Pointer(pMemory)), cgoAllocsUnknown
...
func FreeMemory(device Device_T, memory DeviceMemory_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cmemory, cmemoryAllocMap := *(*C.struct_VkDeviceMemory_T)(unsafe.Pointer(&memory)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func MapMemory(device Device_T, memory DeviceMemory_T, offset DeviceSize, size DeviceSize, flags MemoryMapFlags, ppData *unsafe.Pointer) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cmemory, cmemoryAllocMap := *(*C.struct_VkDeviceMemory_T)(unsafe.Pointer(&memory)), cgoAllocsUnknown
...
func UnmapMemory(device Device_T, memory DeviceMemory_T) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cmemory, cmemoryAllocMap := *(*C.struct_VkDeviceMemory_T)(unsafe.Pointer(&memory)), cgoAllocsUnknown
...
func FlushMappedMemoryRanges(device Device_T, memoryRangeCount uint32, pMemoryRanges []MappedMemoryRange) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
...
func InvalidateMappedMemoryRanges(device Device_T, memoryRangeCount uint32, pMemoryRanges []MappedMemoryRange) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cmemoryRangeCount, cmemoryRangeCountAllocMap := (C.uint32_t)(memoryRangeCount), cgoAllocsUnknown
	cpMemoryRanges, cpMemoryRangesAllocMap := unpackArgSMappedMemoryRange(pMemoryRanges)
...
func GetDeviceMemoryCommitment(device Device_T, memory DeviceMemory_T, pCommittedMemoryInBytes *DeviceSize) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cmemory, cmemoryAllocMap := *(*C.struct_VkDeviceMemory_T)(unsafe.Pointer(&memory)), cgoAllocsUnknown
...
func BindBufferMemory(device Device_T, buffer Buffer_T, memory DeviceMemory_T, memoryOffset DeviceSize) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cbuffer, cbufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&buffer)), cgoAllocsUnknown
	cmemory, cmemoryAllocMap := *(*C.struct_VkDeviceMemory_T)(unsafe.Pointer(&memory)), cgoAllocsUnknown
...
func BindImageMemory(device Device_T, image Image_T, memory DeviceMemory_T, memoryOffset DeviceSize) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cimage, cimageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&image)), cgoAllocsUnknown
	cmemory, cmemoryAllocMap := *(*C.struct_VkDeviceMemory_T)(unsafe.Pointer(&memory)), cgoAllocsUnknown
	cmemoryOffset, cmemoryOffsetAllocMap := (C.VkDeviceSize)(memoryOffset), cgoAllocsUnknown
...
func GetBufferMemoryRequirements(device Device_T, buffer Buffer_T, pMemoryRequirements *MemoryRequirements) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cbuffer, cbufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&buffer)), cgoAllocsUnknown
...
func GetImageMemoryRequirements(device Device_T, image Image_T, pMemoryRequirements *MemoryRequirements) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cimage, cimageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&image)), cgoAllocsUnknown
	cpMemoryRequirements, cpMemoryRequirementsAllocMap := pMemoryRequirements.PassRef()
...
func GetImageSparseMemoryRequirements(device Device_T, image Image_T, pSparseMemoryRequirementCount []uint32, pSparseMemoryRequirements []SparseImageMemoryRequirements) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cimage, cimageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&image)), cgoAllocsUnknown
...
func GetPhysicalDeviceSparseImageFormatProperties(physicalDevice PhysicalDevice_T, format Format, kind ImageType, samples SampleCountFlagBits, usage ImageUsageFlags, tiling ImageTiling, pPropertyCount []uint32, pProperties []SparseImageFormatProperties) {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cformat, cformatAllocMap := (C.VkFormat)(format), cgoAllocsUnknown
	ckind, ckindAllocMap := (C.VkImageType)(kind), cgoAllocsUnknown
...
func QueueBindSparse(queue Queue_T, bindInfoCount uint32, pBindInfo []BindSparseInfo, fence Fence_T) Result {
	cqueue, cqueueAllocMap := *(*C.struct_VkQueue_T)(unsafe.Pointer(&queue)), cgoAllocsUnknown
...
func CreateFence(device Device_T, pCreateInfo *FenceCreateInfo, pAllocator *AllocationCallbacks, pFence *Fence_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpFence, cpFenceAllocMap := (*C.struct_VkFence_T)(unsafe.Pointer(pFence)), cgoAllocsUnknown
...
func DestroyFence(device Device_T, fence Fence_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cfence, cfenceAllocMap := *(*C.struct_VkFence_T)(unsafe.Pointer(&fence)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func ResetFences(device Device_T, fenceCount uint32, pFences []Fence_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cfenceCount, cfenceCountAllocMap := (C.uint32_t)(fenceCount), cgoAllocsUnknown
	cpFences, cpFencesAllocMap := (*C.struct_VkFence_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pFences)).Data)), cgoAllocsUnknown
...
func GetFenceStatus(device Device_T, fence Fence_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cfence, cfenceAllocMap := *(*C.struct_VkFence_T)(unsafe.Pointer(&fence)), cgoAllocsUnknown
...
func WaitForFences(device Device_T, fenceCount uint32, pFences []Fence_T, waitAll Bool32, timeout uint64) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cfenceCount, cfenceCountAllocMap := (C.uint32_t)(fenceCount), cgoAllocsUnknown
	cpFences, cpFencesAllocMap := (*C.struct_VkFence_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pFences)).Data)), cgoAllocsUnknown
...
func CreateSemaphore(device Device_T, pCreateInfo *SemaphoreCreateInfo, pAllocator *AllocationCallbacks, pSemaphore *Semaphore_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpSemaphore, cpSemaphoreAllocMap := (*C.struct_VkSemaphore_T)(unsafe.Pointer(pSemaphore)), cgoAllocsUnknown
...
func DestroySemaphore(device Device_T, semaphore Semaphore_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	csemaphore, csemaphoreAllocMap := *(*C.struct_VkSemaphore_T)(unsafe.Pointer(&semaphore)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func CreateEvent(device Device_T, pCreateInfo *EventCreateInfo, pAllocator *AllocationCallbacks, pEvent *Event_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpEvent, cpEventAllocMap := (*C.struct_VkEvent_T)(unsafe.Pointer(pEvent)), cgoAllocsUnknown
...
func DestroyEvent(device Device_T, event Event_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cevent, ceventAllocMap := *(*C.struct_VkEvent_T)(unsafe.Pointer(&event)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func GetEventStatus(device Device_T, event Event_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cevent, ceventAllocMap := *(*C.struct_VkEvent_T)(unsafe.Pointer(&event)), cgoAllocsUnknown
...
func SetEvent(device Device_T, event Event_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cevent, ceventAllocMap := *(*C.struct_VkEvent_T)(unsafe.Pointer(&event)), cgoAllocsUnknown
...
func ResetEvent(device Device_T, event Event_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cevent, ceventAllocMap := *(*C.struct_VkEvent_T)(unsafe.Pointer(&event)), cgoAllocsUnknown
...
func CreateQueryPool(device Device_T, pCreateInfo *QueryPoolCreateInfo, pAllocator *AllocationCallbacks, pQueryPool *QueryPool_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpQueryPool, cpQueryPoolAllocMap := (*C.struct_VkQueryPool_T)(unsafe.Pointer(pQueryPool)), cgoAllocsUnknown
...
func DestroyQueryPool(device Device_T, queryPool QueryPool_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cqueryPool, cqueryPoolAllocMap := *(*C.struct_VkQueryPool_T)(unsafe.Pointer(&queryPool)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func GetQueryPoolResults(device Device_T, queryPool QueryPool_T, firstQuery uint32, queryCount uint32, dataSize uint64, pData unsafe.Pointer, stride DeviceSize, flags QueryResultFlags) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cqueryPool, cqueryPoolAllocMap := *(*C.struct_VkQueryPool_T)(unsafe.Pointer(&queryPool)), cgoAllocsUnknown
...
func CreateBuffer(device Device_T, pCreateInfo *BufferCreateInfo, pAllocator *AllocationCallbacks, pBuffer *Buffer_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpBuffer, cpBufferAllocMap := (*C.struct_VkBuffer_T)(unsafe.Pointer(pBuffer)), cgoAllocsUnknown
...
func DestroyBuffer(device Device_T, buffer Buffer_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cbuffer, cbufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&buffer)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func CreateBufferView(device Device_T, pCreateInfo *BufferViewCreateInfo, pAllocator *AllocationCallbacks, pView *BufferView_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpView, cpViewAllocMap := (*C.struct_VkBufferView_T)(unsafe.Pointer(pView)), cgoAllocsUnknown
...
func DestroyBufferView(device Device_T, bufferView BufferView_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cbufferView, cbufferViewAllocMap := *(*C.struct_VkBufferView_T)(unsafe.Pointer(&bufferView)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func CreateImage(device Device_T, pCreateInfo *ImageCreateInfo, pAllocator *AllocationCallbacks, pImage *Image_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpImage, cpImageAllocMap := (*C.struct_VkImage_T)(unsafe.Pointer(pImage)), cgoAllocsUnknown
...
func DestroyImage(device Device_T, image Image_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cimage, cimageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&image)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func GetImageSubresourceLayout(device Device_T, image Image_T, pSubresource *ImageSubresource, pLayout *SubresourceLayout) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cimage, cimageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&image)), cgoAllocsUnknown
...
func CreateImageView(device Device_T, pCreateInfo *ImageViewCreateInfo, pAllocator *AllocationCallbacks, pView *ImageView_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpView, cpViewAllocMap := (*C.struct_VkImageView_T)(unsafe.Pointer(pView)), cgoAllocsUnknown
...
func DestroyImageView(device Device_T, imageView ImageView_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cimageView, cimageViewAllocMap := *(*C.struct_VkImageView_T)(unsafe.Pointer(&imageView)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func CreateShaderModule(device Device_T, pCreateInfo *ShaderModuleCreateInfo, pAllocator *AllocationCallbacks, pShaderModule *ShaderModule_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpShaderModule, cpShaderModuleAllocMap := (*C.struct_VkShaderModule_T)(unsafe.Pointer(pShaderModule)), cgoAllocsUnknown
...
func DestroyShaderModule(device Device_T, shaderModule ShaderModule_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cshaderModule, cshaderModuleAllocMap := *(*C.struct_VkShaderModule_T)(unsafe.Pointer(&shaderModule)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func CreatePipelineCache(device Device_T, pCreateInfo *PipelineCacheCreateInfo, pAllocator *AllocationCallbacks, pPipelineCache *PipelineCache_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpPipelineCache, cpPipelineCacheAllocMap := (*C.struct_VkPipelineCache_T)(unsafe.Pointer(pPipelineCache)), cgoAllocsUnknown
...
func DestroyPipelineCache(device Device_T, pipelineCache PipelineCache_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpipelineCache, cpipelineCacheAllocMap := *(*C.struct_VkPipelineCache_T)(unsafe.Pointer(&pipelineCache)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func GetPipelineCacheData(device Device_T, pipelineCache PipelineCache_T, pDataSize *uint64, pData unsafe.Pointer) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpipelineCache, cpipelineCacheAllocMap := *(*C.struct_VkPipelineCache_T)(unsafe.Pointer(&pipelineCache)), cgoAllocsUnknown
...
func MergePipelineCaches(device Device_T, dstCache PipelineCache_T, srcCacheCount uint32, pSrcCaches []PipelineCache_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cdstCache, cdstCacheAllocMap := *(*C.struct_VkPipelineCache_T)(unsafe.Pointer(&dstCache)), cgoAllocsUnknown
	csrcCacheCount, csrcCacheCountAllocMap := (C.uint32_t)(srcCacheCount), cgoAllocsUnknown
	cpSrcCaches, cpSrcCachesAllocMap := (*C.struct_VkPipelineCache_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pSrcCaches)).Data)), cgoAllocsUnknown
...
func CreateGraphicsPipelines(device Device_T, pipelineCache PipelineCache_T, createInfoCount uint32, pCreateInfos []GraphicsPipelineCreateInfo, pAllocator *AllocationCallbacks, pPipelines []Pipeline_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpipelineCache, cpipelineCacheAllocMap := *(*C.struct_VkPipelineCache_T)(unsafe.Pointer(&pipelineCache)), cgoAllocsUnknown
	...
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpPipelines, cpPipelinesAllocMap := (*C.struct_VkPipeline_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pPipelines)).Data)), cgoAllocsUnknown
...
func CreateComputePipelines(device Device_T, pipelineCache PipelineCache_T, createInfoCount uint32, pCreateInfos []ComputePipelineCreateInfo, pAllocator *AllocationCallbacks, pPipelines []Pipeline_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpipelineCache, cpipelineCacheAllocMap := *(*C.struct_VkPipelineCache_T)(unsafe.Pointer(&pipelineCache)), cgoAllocsUnknown
	ccreateInfoCount, ccreateInfoCountAllocMap := (C.uint32_t)(createInfoCount), cgoAllocsUnknown
...
func DestroyPipeline(device Device_T, pipeline Pipeline_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpipeline, cpipelineAllocMap := *(*C.struct_VkPipeline_T)(unsafe.Pointer(&pipeline)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func CreatePipelineLayout(device Device_T, pCreateInfo *PipelineLayoutCreateInfo, pAllocator *AllocationCallbacks, pPipelineLayout *PipelineLayout_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpPipelineLayout, cpPipelineLayoutAllocMap := (*C.struct_VkPipelineLayout_T)(unsafe.Pointer(pPipelineLayout)), cgoAllocsUnknown
...
func DestroyPipelineLayout(device Device_T, pipelineLayout PipelineLayout_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpipelineLayout, cpipelineLayoutAllocMap := *(*C.struct_VkPipelineLayout_T)(unsafe.Pointer(&pipelineLayout)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func CreateSampler(device Device_T, pCreateInfo *SamplerCreateInfo, pAllocator *AllocationCallbacks, pSampler *Sampler_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpSampler, cpSamplerAllocMap := (*C.struct_VkSampler_T)(unsafe.Pointer(pSampler)), cgoAllocsUnknown
...
func DestroySampler(device Device_T, sampler Sampler_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	csampler, csamplerAllocMap := *(*C.struct_VkSampler_T)(unsafe.Pointer(&sampler)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func CreateDescriptorSetLayout(device Device_T, pCreateInfo *DescriptorSetLayoutCreateInfo, pAllocator *AllocationCallbacks, pSetLayout *DescriptorSetLayout_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpSetLayout, cpSetLayoutAllocMap := (*C.struct_VkDescriptorSetLayout_T)(unsafe.Pointer(pSetLayout)), cgoAllocsUnknown
...
func DestroyDescriptorSetLayout(device Device_T, descriptorSetLayout DescriptorSetLayout_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cdescriptorSetLayout, cdescriptorSetLayoutAllocMap := *(*C.struct_VkDescriptorSetLayout_T)(unsafe.Pointer(&descriptorSetLayout)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func CreateDescriptorPool(device Device_T, pCreateInfo *DescriptorPoolCreateInfo, pAllocator *AllocationCallbacks, pDescriptorPool *DescriptorPool_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpDescriptorPool, cpDescriptorPoolAllocMap := (*C.struct_VkDescriptorPool_T)(unsafe.Pointer(pDescriptorPool)), cgoAllocsUnknown
...
func DestroyDescriptorPool(device Device_T, descriptorPool DescriptorPool_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cdescriptorPool, cdescriptorPoolAllocMap := *(*C.struct_VkDescriptorPool_T)(unsafe.Pointer(&descriptorPool)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func ResetDescriptorPool(device Device_T, descriptorPool DescriptorPool_T, flags DescriptorPoolResetFlags) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cdescriptorPool, cdescriptorPoolAllocMap := *(*C.struct_VkDescriptorPool_T)(unsafe.Pointer(&descriptorPool)), cgoAllocsUnknown
...
func AllocateDescriptorSets(device Device_T, pAllocateInfo *DescriptorSetAllocateInfo, pDescriptorSets *DescriptorSet_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpAllocateInfo, cpAllocateInfoAllocMap := pAllocateInfo.PassRef()
	cpDescriptorSets, cpDescriptorSetsAllocMap := (*C.struct_VkDescriptorSet_T)(unsafe.Pointer(pDescriptorSets)), cgoAllocsUnknown
...
func FreeDescriptorSets(device Device_T, descriptorPool DescriptorPool_T, descriptorSetCount uint32, pDescriptorSets *DescriptorSet_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cdescriptorPool, cdescriptorPoolAllocMap := *(*C.struct_VkDescriptorPool_T)(unsafe.Pointer(&descriptorPool)), cgoAllocsUnknown
...
func UpdateDescriptorSets(device Device_T, descriptorWriteCount uint32, pDescriptorWrites []WriteDescriptorSet, descriptorCopyCount uint32, pDescriptorCopies []CopyDescriptorSet) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
...
func CreateFramebuffer(device Device_T, pCreateInfo *FramebufferCreateInfo, pAllocator *AllocationCallbacks, pFramebuffer *Framebuffer_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpFramebuffer, cpFramebufferAllocMap := (*C.struct_VkFramebuffer_T)(unsafe.Pointer(pFramebuffer)), cgoAllocsUnknown
...
func DestroyFramebuffer(device Device_T, framebuffer Framebuffer_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cframebuffer, cframebufferAllocMap := *(*C.struct_VkFramebuffer_T)(unsafe.Pointer(&framebuffer)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func CreateRenderPass(device Device_T, pCreateInfo *RenderPassCreateInfo, pAllocator *AllocationCallbacks, pRenderPass *RenderPass_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpRenderPass, cpRenderPassAllocMap := (*C.struct_VkRenderPass_T)(unsafe.Pointer(pRenderPass)), cgoAllocsUnknown
...
func DestroyRenderPass(device Device_T, renderPass RenderPass_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	crenderPass, crenderPassAllocMap := *(*C.struct_VkRenderPass_T)(unsafe.Pointer(&renderPass)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func GetRenderAreaGranularity(device Device_T, renderPass RenderPass_T, pGranularity *Extent2D) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	crenderPass, crenderPassAllocMap := *(*C.struct_VkRenderPass_T)(unsafe.Pointer(&renderPass)), cgoAllocsUnknown
...
func CreateCommandPool(device Device_T, pCreateInfo *CommandPoolCreateInfo, pAllocator *AllocationCallbacks, pCommandPool *CommandPool_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpCommandPool, cpCommandPoolAllocMap := (*C.struct_VkCommandPool_T)(unsafe.Pointer(pCommandPool)), cgoAllocsUnknown
...
func DestroyCommandPool(device Device_T, commandPool CommandPool_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	ccommandPool, ccommandPoolAllocMap := *(*C.struct_VkCommandPool_T)(unsafe.Pointer(&commandPool)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func ResetCommandPool(device Device_T, commandPool CommandPool_T, flags CommandPoolResetFlags) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	ccommandPool, ccommandPoolAllocMap := *(*C.struct_VkCommandPool_T)(unsafe.Pointer(&commandPool)), cgoAllocsUnknown
...
func AllocateCommandBuffers(device Device_T, pAllocateInfo *CommandBufferAllocateInfo, pCommandBuffers []CommandBuffer_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpAllocateInfo, cpAllocateInfoAllocMap := pAllocateInfo.PassRef()
	cpCommandBuffers, cpCommandBuffersAllocMap := (*C.struct_VkCommandBuffer_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pCommandBuffers)).Data)), cgoAllocsUnknown
...
func FreeCommandBuffers(device Device_T, commandPool CommandPool_T, commandBufferCount uint32, pCommandBuffers []CommandBuffer_T) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	ccommandPool, ccommandPoolAllocMap := *(*C.struct_VkCommandPool_T)(unsafe.Pointer(&commandPool)), cgoAllocsUnknown
...
func BeginCommandBuffer(commandBuffer CommandBuffer_T, pBeginInfo *CommandBufferBeginInfo) Result {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func EndCommandBuffer(commandBuffer CommandBuffer_T) Result {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func ResetCommandBuffer(commandBuffer CommandBuffer_T, flags CommandBufferResetFlags) Result {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdBindPipeline(commandBuffer CommandBuffer_T, pipelineBindPoint PipelineBindPoint, pipeline Pipeline_T) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdSetViewport(commandBuffer CommandBuffer_T, firstViewport uint32, viewportCount uint32, pViewports []Viewport) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdSetScissor(commandBuffer CommandBuffer_T, firstScissor uint32, scissorCount uint32, pScissors []Rect2D) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdSetLineWidth(commandBuffer CommandBuffer_T, lineWidth float32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdSetDepthBias(commandBuffer CommandBuffer_T, depthBiasConstantFactor float32, depthBiasClamp float32, depthBiasSlopeFactor float32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdSetBlendConstants(commandBuffer CommandBuffer_T, blendConstants *float32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdSetDepthBounds(commandBuffer CommandBuffer_T, minDepthBounds float32, maxDepthBounds float32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdSetStencilCompareMask(commandBuffer CommandBuffer_T, faceMask StencilFaceFlags, compareMask uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdSetStencilWriteMask(commandBuffer CommandBuffer_T, faceMask StencilFaceFlags, writeMask uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cfaceMask, cfaceMaskAllocMap := (C.VkStencilFaceFlags)(faceMask), cgoAllocsUnknown
...
func CmdSetStencilReference(commandBuffer CommandBuffer_T, faceMask StencilFaceFlags, reference uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cfaceMask, cfaceMaskAllocMap := (C.VkStencilFaceFlags)(faceMask), cgoAllocsUnknown
...
func CmdBindDescriptorSets(commandBuffer CommandBuffer_T, pipelineBindPoint PipelineBindPoint, layout PipelineLayout_T, firstSet uint32, descriptorSetCount uint32, pDescriptorSets []DescriptorSet_T, dynamicOffsetCount uint32, pDynamicOffsets []uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cpipelineBindPoint, cpipelineBindPointAllocMap := (C.VkPipelineBindPoint)(pipelineBindPoint), cgoAllocsUnknown
	clayout, clayoutAllocMap := *(*C.struct_VkPipelineLayout_T)(unsafe.Pointer(&layout)), cgoAllocsUnknown
	cfirstSet, cfirstSetAllocMap := (C.uint32_t)(firstSet), cgoAllocsUnknown
	cdescriptorSetCount, cdescriptorSetCountAllocMap := (C.uint32_t)(descriptorSetCount), cgoAllocsUnknown
	cpDescriptorSets, cpDescriptorSetsAllocMap := (*C.struct_VkDescriptorSet_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pDescriptorSets)).Data)), cgoAllocsUnknown
...
func CmdBindIndexBuffer(commandBuffer CommandBuffer_T, buffer Buffer_T, offset DeviceSize, indexType IndexType) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cbuffer, cbufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&buffer)), cgoAllocsUnknown
	coffset, coffsetAllocMap := (C.VkDeviceSize)(offset), cgoAllocsUnknown
...
func CmdBindVertexBuffers(commandBuffer CommandBuffer_T, firstBinding uint32, bindingCount uint32, pBuffers []Buffer_T, pOffsets []DeviceSize) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	...
	cpBuffers, cpBuffersAllocMap := (*C.struct_VkBuffer_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pBuffers)).Data)), cgoAllocsUnknown
...
func CmdDraw(commandBuffer CommandBuffer_T, vertexCount uint32, instanceCount uint32, firstVertex uint32, firstInstance uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdDrawIndexed(commandBuffer CommandBuffer_T, indexCount uint32, instanceCount uint32, firstIndex uint32, vertexOffset int32, firstInstance uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdDrawIndirect(commandBuffer CommandBuffer_T, buffer Buffer_T, offset DeviceSize, drawCount uint32, stride uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cbuffer, cbufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&buffer)), cgoAllocsUnknown
	coffset, coffsetAllocMap := (C.VkDeviceSize)(offset), cgoAllocsUnknown
...
func CmdDrawIndexedIndirect(commandBuffer CommandBuffer_T, buffer Buffer_T, offset DeviceSize, drawCount uint32, stride uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cbuffer, cbufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&buffer)), cgoAllocsUnknown
	coffset, coffsetAllocMap := (C.VkDeviceSize)(offset), cgoAllocsUnknown
	cdrawCount, cdrawCountAllocMap := (C.uint32_t)(drawCount), cgoAllocsUnknown
...
func CmdDispatch(commandBuffer CommandBuffer_T, x uint32, y uint32, z uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdDispatchIndirect(commandBuffer CommandBuffer_T, buffer Buffer_T, offset DeviceSize) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cbuffer, cbufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&buffer)), cgoAllocsUnknown
	coffset, coffsetAllocMap := (C.VkDeviceSize)(offset), cgoAllocsUnknown
...
func CmdCopyBuffer(commandBuffer CommandBuffer_T, srcBuffer Buffer_T, dstBuffer Buffer_T, regionCount uint32, pRegions []BufferCopy) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	csrcBuffer, csrcBufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&srcBuffer)), cgoAllocsUnknown
	cdstBuffer, cdstBufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&dstBuffer)), cgoAllocsUnknown
...
func CmdCopyImage(commandBuffer CommandBuffer_T, srcImage Image_T, srcImageLayout ImageLayout, dstImage Image_T, dstImageLayout ImageLayout, regionCount uint32, pRegions []ImageCopy) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	csrcImage, csrcImageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&srcImage)), cgoAllocsUnknown
	csrcImageLayout, csrcImageLayoutAllocMap := (C.VkImageLayout)(srcImageLayout), cgoAllocsUnknown
	cdstImage, cdstImageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&dstImage)), cgoAllocsUnknown
...
func CmdBlitImage(commandBuffer CommandBuffer_T, srcImage Image_T, srcImageLayout ImageLayout, dstImage Image_T, dstImageLayout ImageLayout, regionCount uint32, pRegions []ImageBlit, filter Filter) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	csrcImage, csrcImageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&srcImage)), cgoAllocsUnknown
	csrcImageLayout, csrcImageLayoutAllocMap := (C.VkImageLayout)(srcImageLayout), cgoAllocsUnknown
	cdstImage, cdstImageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&dstImage)), cgoAllocsUnknown
...
func CmdCopyBufferToImage(commandBuffer CommandBuffer_T, srcBuffer Buffer_T, dstImage Image_T, dstImageLayout ImageLayout, regionCount uint32, pRegions []BufferImageCopy) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	csrcBuffer, csrcBufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&srcBuffer)), cgoAllocsUnknown
	cdstImage, cdstImageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&dstImage)), cgoAllocsUnknown
	cdstImageLayout, cdstImageLayoutAllocMap := (C.VkImageLayout)(dstImageLayout), cgoAllocsUnknown
...
func CmdCopyImageToBuffer(commandBuffer CommandBuffer_T, srcImage Image_T, srcImageLayout ImageLayout, dstBuffer Buffer_T, regionCount uint32, pRegions []BufferImageCopy) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	csrcImage, csrcImageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&srcImage)), cgoAllocsUnknown
	csrcImageLayout, csrcImageLayoutAllocMap := (C.VkImageLayout)(srcImageLayout), cgoAllocsUnknown
	cdstBuffer, cdstBufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&dstBuffer)), cgoAllocsUnknown
...
func CmdUpdateBuffer(commandBuffer CommandBuffer_T, dstBuffer Buffer_T, dstOffset DeviceSize, dataSize DeviceSize, pData *uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cdstBuffer, cdstBufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&dstBuffer)), cgoAllocsUnknown
...
func CmdFillBuffer(commandBuffer CommandBuffer_T, dstBuffer Buffer_T, dstOffset DeviceSize, size DeviceSize, data uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cdstBuffer, cdstBufferAllocMap := *(*C.struct_VkBuffer_T)(unsafe.Pointer(&dstBuffer)), cgoAllocsUnknown
	cdstOffset, cdstOffsetAllocMap := (C.VkDeviceSize)(dstOffset), cgoAllocsUnknown
	csize, csizeAllocMap := (C.VkDeviceSize)(size), cgoAllocsUnknown
...
func CmdClearColorImage(commandBuffer CommandBuffer_T, image Image_T, imageLayout ImageLayout, pColor *ClearColorValue, rangeCount uint32, pRanges []ImageSubresourceRange) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cimage, cimageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&image)), cgoAllocsUnknown
...
func CmdClearDepthStencilImage(commandBuffer CommandBuffer_T, image Image_T, imageLayout ImageLayout, pDepthStencil *ClearDepthStencilValue, rangeCount uint32, pRanges []ImageSubresourceRange) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cimage, cimageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&image)), cgoAllocsUnknown
	cimageLayout, cimageLayoutAllocMap := (C.VkImageLayout)(imageLayout), cgoAllocsUnknown
...
func CmdClearAttachments(commandBuffer CommandBuffer_T, attachmentCount uint32, pAttachments []ClearAttachment, rectCount uint32, pRects []ClearRect) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdResolveImage(commandBuffer CommandBuffer_T, srcImage Image_T, srcImageLayout ImageLayout, dstImage Image_T, dstImageLayout ImageLayout, regionCount uint32, pRegions []ImageResolve) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	csrcImage, csrcImageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&srcImage)), cgoAllocsUnknown
	csrcImageLayout, csrcImageLayoutAllocMap := (C.VkImageLayout)(srcImageLayout), cgoAllocsUnknown
	cdstImage, cdstImageAllocMap := *(*C.struct_VkImage_T)(unsafe.Pointer(&dstImage)), cgoAllocsUnknown
...
func CmdSetEvent(commandBuffer CommandBuffer_T, event Event_T, stageMask PipelineStageFlags) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cevent, ceventAllocMap := *(*C.struct_VkEvent_T)(unsafe.Pointer(&event)), cgoAllocsUnknown
...
func CmdResetEvent(commandBuffer CommandBuffer_T, event Event_T, stageMask PipelineStageFlags) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cevent, ceventAllocMap := *(*C.struct_VkEvent_T)(unsafe.Pointer(&event)), cgoAllocsUnknown
	cstageMask, cstageMaskAllocMap := (C.VkPipelineStageFlags)(stageMask), cgoAllocsUnknown
...
func CmdWaitEvents(commandBuffer CommandBuffer_T, eventCount uint32, pEvents []Event_T, srcStageMask PipelineStageFlags, dstStageMask PipelineStageFlags, memoryBarrierCount uint32, pMemoryBarriers []MemoryBarrier, bufferMemoryBarrierCount uint32, pBufferMemoryBarriers []BufferMemoryBarrier, imageMemoryBarrierCount uint32, pImageMemoryBarriers []ImageMemoryBarrier) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	ceventCount, ceventCountAllocMap := (C.uint32_t)(eventCount), cgoAllocsUnknown
	cpEvents, cpEventsAllocMap := (*C.struct_VkEvent_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pEvents)).Data)), cgoAllocsUnknown
...
func CmdPipelineBarrier(commandBuffer CommandBuffer_T, srcStageMask PipelineStageFlags, dstStageMask PipelineStageFlags, dependencyFlags DependencyFlags, memoryBarrierCount uint32, pMemoryBarriers []MemoryBarrier, bufferMemoryBarrierCount uint32, pBufferMemoryBarriers []BufferMemoryBarrier, imageMemoryBarrierCount uint32, pImageMemoryBarriers []ImageMemoryBarrier) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	csrcStageMask, csrcStageMaskAllocMap := (C.VkPipelineStageFlags)(srcStageMask), cgoAllocsUnknown
	cdstStageMask, cdstStageMaskAllocMap := (C.VkPipelineStageFlags)(dstStageMask), cgoAllocsUnknown
...
func CmdBeginQuery(commandBuffer CommandBuffer_T, queryPool QueryPool_T, query uint32, flags QueryControlFlags) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cqueryPool, cqueryPoolAllocMap := *(*C.struct_VkQueryPool_T)(unsafe.Pointer(&queryPool)), cgoAllocsUnknown
...
func CmdEndQuery(commandBuffer CommandBuffer_T, queryPool QueryPool_T, query uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cqueryPool, cqueryPoolAllocMap := *(*C.struct_VkQueryPool_T)(unsafe.Pointer(&queryPool)), cgoAllocsUnknown
	cquery, cqueryAllocMap := (C.uint32_t)(query), cgoAllocsUnknown
...
func CmdResetQueryPool(commandBuffer CommandBuffer_T, queryPool QueryPool_T, firstQuery uint32, queryCount uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cqueryPool, cqueryPoolAllocMap := *(*C.struct_VkQueryPool_T)(unsafe.Pointer(&queryPool)), cgoAllocsUnknown
	cfirstQuery, cfirstQueryAllocMap := (C.uint32_t)(firstQuery), cgoAllocsUnknown
	cqueryCount, cqueryCountAllocMap := (C.uint32_t)(queryCount), cgoAllocsUnknown
...
func CmdWriteTimestamp(commandBuffer CommandBuffer_T, pipelineStage PipelineStageFlagBits, queryPool QueryPool_T, query uint32) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdCopyQueryPoolResults(commandBuffer CommandBuffer_T, queryPool QueryPool_T, firstQuery uint32, queryCount uint32, dstBuffer Buffer_T, dstOffset DeviceSize, stride DeviceSize, flags QueryResultFlags) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	cqueryPool, cqueryPoolAllocMap := *(*C.struct_VkQueryPool_T)(unsafe.Pointer(&queryPool)), cgoAllocsUnknown
	cfirstQuery, cfirstQueryAllocMap := (C.uint32_t)(firstQuery), cgoAllocsUnknown
	cqueryCount, cqueryCountAllocMap := (C.uint32_t)(queryCount), cgoAllocsUnknown
...
func CmdPushConstants(commandBuffer CommandBuffer_T, layout PipelineLayout_T, stageFlags ShaderStageFlags, offset uint32, size uint32, pValues unsafe.Pointer) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	clayout, clayoutAllocMap := *(*C.struct_VkPipelineLayout_T)(unsafe.Pointer(&layout)), cgoAllocsUnknown
...
func CmdBeginRenderPass(commandBuffer CommandBuffer_T, pRenderPassBegin *RenderPassBeginInfo, contents SubpassContents) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdNextSubpass(commandBuffer CommandBuffer_T, contents SubpassContents) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	ccontents, ccontentsAllocMap := (C.VkSubpassContents)(contents), cgoAllocsUnknown
...
func CmdEndRenderPass(commandBuffer CommandBuffer_T) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
...
func CmdExecuteCommands(commandBuffer CommandBuffer_T, commandBufferCount uint32, pCommandBuffers []CommandBuffer_T) {
	ccommandBuffer, ccommandBufferAllocMap := *(*C.struct_VkCommandBuffer_T)(unsafe.Pointer(&commandBuffer)), cgoAllocsUnknown
	ccommandBufferCount, ccommandBufferCountAllocMap := (C.uint32_t)(commandBufferCount), cgoAllocsUnknown
	cpCommandBuffers, cpCommandBuffersAllocMap := (*C.struct_VkCommandBuffer_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pCommandBuffers)).Data)), cgoAllocsUnknown
...
func DestroySurface(instance Instance_T, surface SurfaceKHR_T, pAllocator *AllocationCallbacks) {
	cinstance, cinstanceAllocMap := *(*C.struct_VkInstance_T)(unsafe.Pointer(&instance)), cgoAllocsUnknown
	csurface, csurfaceAllocMap := *(*C.struct_VkSurfaceKHR_T)(unsafe.Pointer(&surface)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func GetPhysicalDeviceSurfaceSupport(physicalDevice PhysicalDevice_T, queueFamilyIndex uint32, surface SurfaceKHR_T, pSupported *Bool32) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cqueueFamilyIndex, cqueueFamilyIndexAllocMap := (C.uint32_t)(queueFamilyIndex), cgoAllocsUnknown
	csurface, csurfaceAllocMap := *(*C.struct_VkSurfaceKHR_T)(unsafe.Pointer(&surface)), cgoAllocsUnknown
...
func GetPhysicalDeviceSurfaceCapabilities(physicalDevice PhysicalDevice_T, surface SurfaceKHR_T, pSurfaceCapabilities *SurfaceCapabilities) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	csurface, csurfaceAllocMap := *(*C.struct_VkSurfaceKHR_T)(unsafe.Pointer(&surface)), cgoAllocsUnknown
...
func GetPhysicalDeviceSurfaceFormats(physicalDevice PhysicalDevice_T, surface SurfaceKHR_T, pSurfaceFormatCount *uint32, pSurfaceFormats []SurfaceFormat) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	csurface, csurfaceAllocMap := *(*C.struct_VkSurfaceKHR_T)(unsafe.Pointer(&surface)), cgoAllocsUnknown
...
func GetPhysicalDeviceSurfacePresentModes(physicalDevice PhysicalDevice_T, surface SurfaceKHR_T, pPresentModeCount *uint32, pPresentModes []PresentMode) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	csurface, csurfaceAllocMap := *(*C.struct_VkSurfaceKHR_T)(unsafe.Pointer(&surface)), cgoAllocsUnknown
...
func CreateSwapchain(device Device_T, pCreateInfo *SwapchainCreateInfo, pAllocator *AllocationCallbacks, pSwapchain *SwapchainKHR_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpSwapchain, cpSwapchainAllocMap := (*C.struct_VkSwapchainKHR_T)(unsafe.Pointer(pSwapchain)), cgoAllocsUnknown
...
func DestroySwapchain(device Device_T, swapchain SwapchainKHR_T, pAllocator *AllocationCallbacks) {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cswapchain, cswapchainAllocMap := *(*C.struct_VkSwapchainKHR_T)(unsafe.Pointer(&swapchain)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func GetSwapchainImages(device Device_T, swapchain SwapchainKHR_T, pSwapchainImageCount *uint32, pSwapchainImages []Image_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cswapchain, cswapchainAllocMap := *(*C.struct_VkSwapchainKHR_T)(unsafe.Pointer(&swapchain)), cgoAllocsUnknown
	cpSwapchainImageCount, cpSwapchainImageCountAllocMap := (*C.uint32_t)(unsafe.Pointer(pSwapchainImageCount)), cgoAllocsUnknown
	cpSwapchainImages, cpSwapchainImagesAllocMap := (*C.struct_VkImage_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pSwapchainImages)).Data)), cgoAllocsUnknown
...
func AcquireNextImage(device Device_T, swapchain SwapchainKHR_T, timeout uint64, semaphore Semaphore_T, fence Fence_T, pImageIndex *uint32) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cswapchain, cswapchainAllocMap := *(*C.struct_VkSwapchainKHR_T)(unsafe.Pointer(&swapchain)), cgoAllocsUnknown
	ctimeout, ctimeoutAllocMap := (C.uint64_t)(timeout), cgoAllocsUnknown
	csemaphore, csemaphoreAllocMap := *(*C.struct_VkSemaphore_T)(unsafe.Pointer(&semaphore)), cgoAllocsUnknown
...
func QueuePresent(queue Queue_T, pPresentInfo *PresentInfo) Result {
	cqueue, cqueueAllocMap := *(*C.struct_VkQueue_T)(unsafe.Pointer(&queue)), cgoAllocsUnknown
...
func GetPhysicalDeviceDisplayProperties(physicalDevice PhysicalDevice_T, pPropertyCount *uint32, pProperties []DisplayProperties) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cpPropertyCount, cpPropertyCountAllocMap := (*C.uint32_t)(unsafe.Pointer(pPropertyCount)), cgoAllocsUnknown
...
func GetPhysicalDeviceDisplayPlaneProperties(physicalDevice PhysicalDevice_T, pPropertyCount *uint32, pProperties []DisplayPlaneProperties) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cpPropertyCount, cpPropertyCountAllocMap := (*C.uint32_t)(unsafe.Pointer(pPropertyCount)), cgoAllocsUnknown
...
func GetDisplayPlaneSupportedDisplays(physicalDevice PhysicalDevice_T, planeIndex uint32, pDisplayCount *uint32, pDisplays []DisplayKHR_T) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	...
	cpDisplays, cpDisplaysAllocMap := (*C.struct_VkDisplayKHR_T)(unsafe.Pointer((*sliceHeader)(unsafe.Pointer(&pDisplays)).Data)), cgoAllocsUnknown
...
func GetDisplayModeProperties(physicalDevice PhysicalDevice_T, display DisplayKHR_T, pPropertyCount *uint32, pProperties []DisplayModeProperties) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cdisplay, cdisplayAllocMap := *(*C.struct_VkDisplayKHR_T)(unsafe.Pointer(&display)), cgoAllocsUnknown
	cpPropertyCount, cpPropertyCountAllocMap := (*C.uint32_t)(unsafe.Pointer(pPropertyCount)), cgoAllocsUnknown
...
func CreateDisplayMode(physicalDevice PhysicalDevice_T, display DisplayKHR_T, pCreateInfo *DisplayModeCreateInfo, pAllocator *AllocationCallbacks, pMode *DisplayModeKHR_T) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cdisplay, cdisplayAllocMap := *(*C.struct_VkDisplayKHR_T)(unsafe.Pointer(&display)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpMode, cpModeAllocMap := (*C.struct_VkDisplayModeKHR_T)(unsafe.Pointer(pMode)), cgoAllocsUnknown
...
func GetDisplayPlaneCapabilities(physicalDevice PhysicalDevice_T, mode DisplayModeKHR_T, planeIndex uint32, pCapabilities *DisplayPlaneCapabilities) Result {
	cphysicalDevice, cphysicalDeviceAllocMap := *(*C.struct_VkPhysicalDevice_T)(unsafe.Pointer(&physicalDevice)), cgoAllocsUnknown
	cmode, cmodeAllocMap := *(*C.struct_VkDisplayModeKHR_T)(unsafe.Pointer(&mode)), cgoAllocsUnknown
	cplaneIndex, cplaneIndexAllocMap := (C.uint32_t)(planeIndex), cgoAllocsUnknown
...
func CreateDisplayPlaneSurface(instance Instance_T, pCreateInfo *DisplaySurfaceCreateInfo, pAllocator *AllocationCallbacks, pSurface *SurfaceKHR_T) Result {
	cinstance, cinstanceAllocMap := *(*C.struct_VkInstance_T)(unsafe.Pointer(&instance)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpSurface, cpSurfaceAllocMap := (*C.struct_VkSurfaceKHR_T)(unsafe.Pointer(pSurface)), cgoAllocsUnknown
...
func CreateSharedSwapchains(device Device_T, swapchainCount uint32, pCreateInfos []SwapchainCreateInfo, pAllocator *AllocationCallbacks, pSwapchains *SwapchainKHR_T) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	...
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpSwapchains, cpSwapchainsAllocMap := (*C.struct_VkSwapchainKHR_T)(unsafe.Pointer(pSwapchains)), cgoAllocsUnknown
...
func CreateDebugReportCallback(instance Instance_T, pCreateInfo *DebugReportCallbackCreateInfo, pAllocator *AllocationCallbacks, pCallback *DebugReportCallbackEXT_T) Result {
	cinstance, cinstanceAllocMap := *(*C.struct_VkInstance_T)(unsafe.Pointer(&instance)), cgoAllocsUnknown
	cpCreateInfo, cpCreateInfoAllocMap := pCreateInfo.PassRef()
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
	cpCallback, cpCallbackAllocMap := (*C.struct_VkDebugReportCallbackEXT_T)(unsafe.Pointer(pCallback)), cgoAllocsUnknown
...
func DestroyDebugReportCallback(instance Instance_T, callback DebugReportCallbackEXT_T, pAllocator *AllocationCallbacks) {
	cinstance, cinstanceAllocMap := *(*C.struct_VkInstance_T)(unsafe.Pointer(&instance)), cgoAllocsUnknown
	ccallback, ccallbackAllocMap := *(*C.struct_VkDebugReportCallbackEXT_T)(unsafe.Pointer(&callback)), cgoAllocsUnknown
	cpAllocator, cpAllocatorAllocMap := (*C.VkAllocationCallbacks)(unsafe.Pointer(pAllocator)), cgoAllocsUnknown
...
func DebugReportMessage(instance Instance_T, flags DebugReportFlags, objectType DebugReportObjectType, object uint64, location uint64, messageCode int32, pLayerPrefix string, pMessage string) {
	cinstance, cinstanceAllocMap := *(*C.struct_VkInstance_T)(unsafe.Pointer(&instance)), cgoAllocsUnknown
...
func GetRefreshCycleDurationGOOGLE(device Device_T, swapchain SwapchainKHR_T, pDisplayTimingProperties *RefreshCycleDurationGOOGLE) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cswapchain, cswapchainAllocMap := *(*C.struct_VkSwapchainKHR_T)(unsafe.Pointer(&swapchain)), cgoAllocsUnknown
...
func GetPastPresentationTimingGOOGLE(device Device_T, swapchain SwapchainKHR_T, pPresentationTimingCount *uint32, pPresentationTimings *PastPresentationTimingGOOGLE) Result {
	cdevice, cdeviceAllocMap := *(*C.struct_VkDevice_T)(unsafe.Pointer(&device)), cgoAllocsUnknown
	cswapchain, cswapchainAllocMap := *(*C.struct_VkSwapchainKHR_T)(unsafe.Pointer(&swapchain)), cgoAllocsUnknown
