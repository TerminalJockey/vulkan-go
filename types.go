...
type ObjectTableNVX C.struct_VkObjectTableNVX_T
...
type IndirectCommandsLayoutNVX C.struct_VkIndirectCommandsLayoutNVX_T
...
type CmdProcessCommandsInfoNVX struct {
	SType                      StructureType
	PNext                      unsafe.Pointer
	ObjectTable                ObjectTableNVX_T
	IndirectCommandsLayout     IndirectCommandsLayoutNVX_T
	IndirectCommandsTokenCount uint32
	PIndirectCommandsTokens    []IndirectCommandsTokenNVX
	MaxSequencesCount          uint32
	TargetCommandBuffer        CommandBuffer_T
...
type AccelerationStructureNVX C.struct_VkAccelerationStructureNVX_T
...
type BindAccelerationStructureMemoryInfoNVX struct {
	SType                 StructureType
	PNext                 unsafe.Pointer
	AccelerationStructure AccelerationStructureNVX_T
	Memory                DeviceMemory_T
	MemoryOffset          DeviceSize
	DeviceIndexCount      uint32
	PDeviceIndices        []uint32
...
type DescriptorAccelerationStructureInfoNVX struct {
	...
	PAccelerationStructures    []AccelerationStructureNVX_T
